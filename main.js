...
var $author$project$HomePage$leftMainDiv = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
			$elm$html$Html$Attributes$class('div-left-main-content-background')
		]),
	_List_Nil);
...
var $author$project$HomePage$introductionContentView = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
			$elm$html$Html$Attributes$class('div-content-main-content')
		]),
	_List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					A2($elm$html$Html$Attributes$style, 'margin', '5%')
				]),
			_List_fromArray(
				[
...
var $author$project$HomePage$mainDiv = A2(
	...
	_List_fromArray(
		[
			$elm$html$Html$Attributes$class('div-main-main-content-background')
		]),
	_List_fromArray(
		[
			A2(
			...
			_List_Nil,
			_List_fromArray(
				[$author$project$HomePage$introductionContentView]))
		]));
var $author$project$HomePage$rightMainDiv = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
...
var $author$project$HomePage$languageView = A2(
	...
	_List_fromArray(
		[
			$elm$html$Html$Attributes$class('div-header-intro-breakline')
		]),
	_List_fromArray(
		[
			A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('div-header-intro-left-content')
				]),
			_List_fromArray(
				[
					A2(
...
var $author$project$HomePage$titleView = A2(
	$elm$html$Html$div,
	_List_Nil,
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('div-title')
				]),
			_List_fromArray(
				[
					$elm$html$Html$text('Hi, I\'m Hoàng!')
				])),
			A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('div-sub-title')
				]),
			_List_fromArray(
				[
